...
INSERT INTO historical_box (id, emperor_id, regime_id, dynasty_id, civilization_code, title, category_key, blurb, start_year, end_year, importance_level, status, detail_md, original_ref_json)
VALUES
  ('box_wutai_1079', 'huaxia_song_shenzong', 'regime_song_hx', 'dyn_song_hx', 'HX', '乌台诗案', 'shilue', '文字狱', 1079, 1079, 5, 1, '苏轼文字狱。', '{}'),
  ('box_bianfa', 'huaxia_song_shenzong', 'regime_song_hx', 'dyn_song_hx', 'HX', '熙宁变法', 'dianzhi', '变法', 1069, 1076, 4, 1, '变法概述。', '{}');
