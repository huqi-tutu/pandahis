#!/usr/bin/env python3
"""Resume 汉武帝 Phase2 from chapter 3 (reuse fixed ch01/ch02)."""
...
def main() -> int:
    ...
    voice_sample = extract_voice_sample(parts[-1])

    for ci in range(3, total + 1):
