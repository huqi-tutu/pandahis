Component({
    ...
    methods: {
        _recomputeStyle() {
            ...
            if (metrics) {
                parts.push(`height: ${metrics.totalHeight}px`, `padding-top: ${metrics.statusBarHeight}px`, `padding-left: ${metrics.paddingLeft}px`, `padding-right: ${metrics.paddingRight}px`);
            }
