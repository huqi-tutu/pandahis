...
from lib.openclaw import build_source_plan_prompt
from lib.plan_postprocess import build_plan_skeleton, merge_llm_plan_decisions
...
for attempt in range(3):
    ...
    print(f"   raw_head={content[:240]!r}", flush=True)
